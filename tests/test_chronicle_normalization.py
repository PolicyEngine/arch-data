"""Tests for Chronicle structural normalization helpers."""

import pytest

from chronicle.targets import DataSource, Jurisdiction, TargetType
from chronicle.normalization import (
    SourceFact,
    apply_share,
    as_target,
    convert_units,
