"""Tests for the Chronicle fact validation harness."""

from __future__ import annotations

import json

from chronicle.harness import build_fixture_fact_file, validate_fixture_facts
from chronicle.store import load_facts_jsonl
