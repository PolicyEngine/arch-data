...
Chronicle stores source-backed claims only. Publisher projections are facts
...
from chronicle.source_package import DeclarativeRecordSet
from chronicle.store import fact_from_mapping, fact_to_mapping, load_facts_jsonl

ROOT = Path(__file__).resolve().parents[1]
FIXTURE_FACTS = ROOT / "chronicle" / "fixtures" / "facts.jsonl"
...
def test_governance_docs_state_the_facts_only_boundary():
    ...
    governance = (ROOT / "docs" / "chronicle-governance.md").read_text()
