...
def test_build_bundle_writes_merged_consumer_contract(tmp_path):
    ...
    assert summary["counts"] == {
        ...
        "source_count": 41,
        "source_package_count": 143,
        "warning_count": 1,
    }
    assert len(rows) == 156030
    ...
    assert source_packages["source_package_count"] == 143
    ...
    assert coverage["fact_count"] == 156030
