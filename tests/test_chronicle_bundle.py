...
def test_build_bundle_writes_merged_consumer_contract(tmp_path):
    ...
    assert summary["counts"] == {
        ...
        "source_count": 34,
        "source_package_count": 75,
        "warning_count": 1,
    }
    assert len(rows) == 40401
    ...
    assert source_packages["source_package_count"] == 75
    ...
    assert coverage["fact_count"] == 40401
    ...
    assert coverage["counts"]["by_geography"]["country:K03000001"] == 111
