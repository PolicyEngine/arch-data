...
|---|---|---|---|
| PIP daily-living awards ([`dwp.py`](https://github.com/PolicyEngine/policyengine-uk-data/blob/ebf733c/policyengine_uk_data/targets/sources/dwp.py)) | `dwp/pip_dl_{standard,enhanced}_claimants` (1,283,000 / 1,608,000 at 2025) | `dwp-pip-daily-living-foi-2025` (2 facts, month 2025-01) | **Re-pinned — scoping correction (2026-08-07):** uk-data cites [PIP statistics to January 2026](https://www.gov.uk/government/statistics/personal-independence-payment-statistics-to-january-2026), but that publication's tables carry clearance/journey statistics only. The true publisher is DWP FOI response **FOI2025/24990** (caseload at end-January 2025, PIP administrative data), published via [WhatDoTheyKnow](https://www.whatdotheyknow.com/request/personal_independence_payment_pi_7); its host blocks automated fetches, so the PDF was downloaded manually in a browser and its sha256 pins the bytes. Publisher scope carried as constraints: DWP policy ownership (England, Wales and Abroad), working-age, normal rules only. |
...
| UC claimants by family type | 4 `dwp/uc/claimants_{family_type}` | `dwp-uc-households-family-type-may-2025` (5 facts) | Raw publisher counts only — uk-data's `undercount_relative` inflation is **excluded (computed)** and stays populace-side. |
| Scotland UC households, child under 1 | 1 `dwp/scotland_uc_households_child_under_1` (14,000) | `dwp-uc-scotland-youngest-child-may-2025` (23 facts, single year of age) | The age-0 row (14,412) is the precise value behind uk-data's rounded 14,000. Single-year cells differ from the published 0–4 band by 4 households — Stat-Xplore disclosure-control rounding, both publisher-emitted. |
