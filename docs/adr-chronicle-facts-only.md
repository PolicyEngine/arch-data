...
1. Anything a publisher asserted is a fact — including the publisher's own
   ...
   microdata release) is content, not a fact; only the values
   a publisher asserted and published over that microdata are facts. "CBO's
   January 2026 baseline projects individual income tax
