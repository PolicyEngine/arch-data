...
|-------|------|--------------|
| Chronicle | Source artifacts (including microdata release registrations), provenance, aggregate facts, constraints | Selection and measurement contracts, microdata rows, cells, and facts computed directly from raw microdata; licensed or restricted microdata bytes; source reconciliation, aging, imputation, active target selection |
